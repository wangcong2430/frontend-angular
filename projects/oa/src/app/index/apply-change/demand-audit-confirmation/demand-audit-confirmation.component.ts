...
@Component({
  templateUrl: './demand-audit-confirmation.component.html',
})

export class DemandAuditConfirmationComponent implements OnInit {
  constructor(
  ...
  getConfig() {
    this.loading = true;
    this.http.get('web/apply-change/demand-audit-config').subscribe(result => {
      this.loading = false;
  ...
  getList(pagination?: null) {
    ...
    this.http.get('web/apply-change/demand-audit-confirmation-list', {params: params}).subscribe(result => {
  ...
  confirmationSubmit(optionType){
    ...
    this.http.post('/web/apply-change/demand-audit-confirmation-submit', {
        thing_id: thing_id,
