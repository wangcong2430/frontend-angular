...
@Component({
  templateUrl: './brand-manager-confirmation.component.html',
})

export class BrandManagerConfirmationComponent implements OnInit {
  constructor(
  ...
  getConfig() {
    this.loading = true;
    this.http.get('web/apply-change/brand-manager-config').subscribe(result => {
      this.loading = false;
  ...
  getList(pagination?: null) {
    ...
    this.http.get('web/apply-change/brand-manager-confirmation-list', {params: params}).subscribe(result => {
  ...
  confirmationSubmit(optionType) {
    ...
    this.http.post('/web/apply-change/brand-manager-confirmation-submit', {
        thing_id: thing_id,
