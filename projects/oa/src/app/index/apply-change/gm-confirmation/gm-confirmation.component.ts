...
@Component({
  templateUrl: './gm-confirmation.component.html',
})

export class GmConfirmationComponent implements OnInit {
  constructor(
  ...
  getList(pagination?: null) {
    ...
    this.http.get('web/apply-change/upgrade-order-approval-gm-confirmation-list', {params: params}).subscribe(result => {
  ...
  confirmationSubmit(optionType){
    ...
    this.http.post('/web/apply-change/upgrade-order-approval-gm-confirmation-' + optionType, {
        thing_id: thing_id,
        reason: this.reason
      }
    ).subscribe(result => {
