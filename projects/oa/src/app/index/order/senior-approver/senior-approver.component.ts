...
@Component({
  templateUrl: './senior-approver.component.html'
})

export class SeniorApproveComponent implements OnInit {
  loading = true;
  listLoading = false;
  // 配置项
  columns = [];
  ...
  getConfig() {
    this.loading = true;
    this.http.get('web/order/senior-approval-order-configs').subscribe(result => {
      this.loading          = false;
  ...
  getList(pagination?: null) {
    ...
    this.http.get('web/order/senior-approval-list', { params: params }).subscribe(result => {
  ...
  changeDisabledButton(value) {
   ...
   confirmationSubmit(optionType): void {
    ...
    this.http.post('web/order/senior-approval-submit-' + optionType, {
        thing_ids: thing_ids,
        reason: this.reason
      }
    ).subscribe(result => {
