...
export class IndexComponent implements OnInit {
  ...
  getData (title = '') {
    ...
    forkJoin(
      ...
      this.http.get('web/bulletin/list', {params: {'is_top': '1', title: title,'type':'1'}}),
      this.http.get('web/bulletin/list', {params: {page_index: '1', page_size: '20', title: title,'type':'1'}}),
    ).subscribe(item => {
  ...
  onSignup(id,is_external_link,external_link,index){
    console.log("测试",id,is_external_link,external_link,index)
    if(is_external_link){
